...
<div class="col-lg-9 col-md-8 col-sm-12">
    <form method="GET" class="row align-items-end">
        ...
        <div class="col-md-2 p-0 px-1">
            <button class="btn btn-sm btn-secondary m-0" type="submit" style="padding: .375rem 1rem;"><i class="fa fa-filter"></i> <?php esc_html_e('Filter', 'sendtrace') ?></button>
        </div>
    </form>
</div>
<!-- Search -->
    ...
    <form method="GET">
        ...
        <div class="input-group bg-white">
            ...
            <div class="input-group-append">
                <button class="btn btn-sm btn-secondary m-0" type="submit"><i class="fa fa-search"></i> <?php esc_html_e('Search', 'sendtrace') ?></button>
            </div>
        </div>
    </form>
</div>
