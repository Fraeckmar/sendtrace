                            ...
                            foreach ($setting['fields'] as $field) {
                                if (array_key_exists($field['key'], $_POST[$setting_key])) {
                                    if (array_key_exists('allow_html', $field) && $field['allow_html']) {
                                        $setting_value[$field['key']] = wp_kses($_POST[$setting_key][$field['key']], wpst_allowed_html_tags());
                                    } else {
                                        $setting_value[$field['key']] = wpst_sanitize_data($_POST[$setting_key][$field['key']]);
                                    } 
                                }
